...
{
    class Enemy //pg 127, adding enemies
    {
        ...
        public Enemy(//pg 127, constructor
            Texture2D texture,
            Vector2 location,
            ...
            int frameCount)
        {
            ...
            EnemySprite.CollisionRadius = enemyRadius; //end pg 127
        }
        ...
        public bool WaypointReached()//pg 129, waypoint management
        {
        ...
        public void Update(GameTime gameTime) //pg 130, enemy update and draw
        {
            if (IsActive())
            {
